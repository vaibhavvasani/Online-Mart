                                    ...
                                    <div class="card">
                                        <div class="thumb-content">
                                            <!-- <div class="price">$200</div> -->
                                                ...
                                                <img class="card-img-top img-fluid" src="images/products/Anti Hair Loss Botanical Organic Shampoo.png" alt="Card image cap">
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                            <h4 class="card-title">Anti Hair Loss Botanical Organic Shampoo</h4>
                                    ...
                                    <div class="card">
                                        <div class="thumb-content">
                                            <!-- <div class="price">$200</div> -->
                                                ...
                                                <img class="card-img-top img-fluid" src="images/products/Bio White - Advanced Fairness Face Wash for All Skin Types.jpg" alt="Card image cap">
                                            
                                        </div>
                                        <div class="card-body">
                                        <?php 
                                                $sql = "SELECT * FROM plant_pot WHERE pro_id=2";
                                                $result = mysqli_query($con, $sql);
                                                $row = mysqli_fetch_array($result);
                                                $detail=$row['detail'];
                                                $quantity=$row['quantity'];
                                                ...
                                                $seller_id=$row['seller_id'];
                                            ?>
                                            <h4 class="card-title">Bio White - Advanced Fairness Face Wash for All Skin Types</h4>
                                            <ul class="list-inline product-meta">
                                                <li class="list-inline-item">
                                                    <a href="plants_pots.php"><i class="fa fa-folder-open-o"></i>Plants_Pots</a>
                                                </li>
                                    ...
                                    <div class="card">
                                        <div class="thumb-content">
                                            <!-- <div class="price">$200</div> -->
                                                ...
                                                <img class="card-img-top img-fluid" src="images/products/BOTANIC SPA RITUALS face care - Bielenda.jpg" alt="Card image cap">
                                            
                                        </div>
                                        <div class="card-body">
                                        <?php 
                                                $sql = "SELECT * FROM plant_pot WHERE pro_id=3";
                                                $result = mysqli_query($con, $sql);
                                                $row = mysqli_fetch_array($result);
                                                $detail=$row['detail'];
                                                $quantity=$row['quantity'];
                                                ...
                                                $seller_id=$row['seller_id'];
                                            ?>
                                            <h4 class="card-title">BOTANIC SPA RITUALS face care - Bielenda</h4>
                                            <ul class="list-inline product-meta">
                                                <li class="list-inline-item">
                                                    <a href="plants_pots.php"><i class="fa fa-folder-open-o"></i>Plants_Pots</a>
                                                </li>
                            ...
                            <div class="col-sm-12 col-lg-4 col-md-6">
                                ...
                                <div class="product-item bg-light">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                        <?php 
                                                $sql = "SELECT * FROM plant_pot WHERE pro_id=4";
                                                $result = mysqli_query($con, $sql);
                                                $row = mysqli_fetch_array($result);
                                                $detail=$row['detail'];
                                                $quantity=$row['quantity'];
                                    ...
                                    <div class="card">
                                        <div class="thumb-content">
                                            <!-- <div class="price">$200</div> -->
                                                ...
                                                <img class="card-img-top img-fluid" src="images/products/CHI Olive Organics Product Page - CHI Haircare - Pro Hair Care.png" alt="Card image cap">
                                            
                                        </div>
                                        <div class="card-body">
                                        <?php 
                                                $sql = "SELECT * FROM plant_pot WHERE pro_id=5";
                                                $result = mysqli_query($con, $sql);
                                                $row = mysqli_fetch_array($result);
                                                $detail=$row['detail'];
                                                $quantity=$row['quantity'];
                                                ...
                                                $seller_id=$row['seller_id'];
                                            ?>
                                            <h4 class="card-title">CHI Olive Organics Product Page - CHI Haircare - Pro Hair Care</h4>
                                            <ul class="list-inline product-meta">
                                                <li class="list-inline-item">
                                                    <a href="plants_pots.php"><i class="fa fa-folder-open-o"></i>Plants_Pots</a>
                                                </li>
