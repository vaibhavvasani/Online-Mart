                                ...
                                <div class="product-item bg-light">
                                    <div class="card">
                                        <div class="thumb-content">
                                            <!-- <div class="price">$200</div> -->
                                            <!-- <a href="single.php"> -->
                                                <img class="card-img-top img-fluid" src="images/products/sofa.jpg" alt="Card image cap">
                                            <!-- </a> -->
                                        </div>
                                        <div class="card-body">
                                        <?php 
                                                $sql = "SELECT * FROM fur WHERE pro_id=2";
                                                $result = mysqli_query($con, $sql);
                                                $row = mysqli_fetch_array($result);
                                                $detail=$row['detail'];
                                                $quantity=$row['quantity'];
                                            ...
                                            ?>
                                            <h4 class="card-title" name="study table">Sofa</h4>
                                            <ul class="list-inline product-meta">
                                                <li class="list-inline-item">
                                                    <a href="furniture.php"><i class="fa fa-folder-open-o"></i>Furnitures</a>
                                                </li>
